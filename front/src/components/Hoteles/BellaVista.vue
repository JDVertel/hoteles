...
<div style="text-align: center; margin-bottom: 25px">
    <div style="margin-bottom: 20px; display: inline-block">
        <div class="input-group">
            <span style="background-color: #b7642d; color: #fff" class="input-group-text" id="addon-wrapping">Fecha de ingreso</span>
    ...
    <div style="display: inline-block">
        <div class="input-group">
            <span style="background-color: #b7642d; color: #fff" class="input-group-text" id="addon-wrapping">Fecha del egreso</span>
            <input type="date" class="form-control" />
        </div>
    </div>
</div>
    ...
    <div class="imagen">
        ...
        <div class="overlay">
          ...
          ">
                <i class="material-icons" style="margin-top: -2.2px; margin-left: -3px">person</i>
                2
                <i class="material-icons" style="margin-right: 2px; margin-left: 10px">bed</i>
            </h2>
            <h3 style="
            display: inline-flex;
            align-items: center;
    ...
    <div class="imagen">
        ...
        <div class="overlay">
          ...
          ">
                <i class="material-icons" style="margin-top: -2.2px; margin-left: -3px">person</i>
                4
                <i class="material-icons" style="margin-right: 2px; margin-left: 10px">desk</i>
            </h2>
            <h3 style="
            display: inline-flex;
            align-items: center;
